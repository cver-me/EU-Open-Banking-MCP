/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: d6e309431fd9658444d6b4b3cbdeb2cb)
// Runtime types generated with workerd@1.20260903.1 2026-08-23 nodejs_compat
interface __BaseEnv_Env {
	SESSION_STORE: KVNamespace;
	ENABLE_BANKING_APPLICATION_ID: string;
	ENABLE_BANKING_PRIVATE_KEY_PEM: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENABLE_BANKING_APPLICATION_ID" | "ENABLE_BANKING_PRIVATE_KEY_PEM">> {}
}
